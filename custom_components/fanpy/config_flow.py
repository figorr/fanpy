...
class FanpyConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_direct_light_temp_modes(self, user_input=None):
        ...
        schema = _build_schemas(self._data, step="direct_light_temp_modes")
    ...
    async def async_step_helpers_light_temp_modes(self, user_input=None):
        ...
        schema = _build_schemas(self._data, step="helpers_light_temp_modes")
    ...
    def async_get_options_flow(config_entry):
        from .options_flow import FanpyOptionsFlowHandler
        return FanpyOptionsFlowHandler(config_entry)
